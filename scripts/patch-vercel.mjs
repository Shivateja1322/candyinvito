...
if (fs.existsSync(serverIndex)) {
  ...
  // 1. Inline tslib helpers to make index.mjs 100% self-contained with 0 external dependencies
...
function __spreadArray(to, from, pack) {
  ...
  // 2. Replace the nodeHandler function with a bulletproof, exception-safe version
